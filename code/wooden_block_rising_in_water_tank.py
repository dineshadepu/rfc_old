"""Taken from \cite{}, this is inturn was done in
...
class RigidFluidCoupling(Application):
    def initialize(self):
        ...
        self.tank_height = 70. * 1e-3
        self.tank_spacing = spacing
        self.tank_layers = 3

        self.body_length = 49. * 1e-3
        self.body_width = 48. * 1e-3
        self.body_height = 24 * 1e-3
        self.body_density = 800.52
    ...
    def create_particles(self):
        ...
        xb += 50 * 1e-3 - self.body_spacing/2.
