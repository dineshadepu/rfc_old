...
class Dinesh2022TwoCircularBodiesHittingHeadOn(Application):
    def initialize(self):
        spacing = 0.01
        self.hdx = 1.3
...
if __name__ == '__main__':
    app = Dinesh2022TwoCircularBodiesHittingHeadOn()
    app.run()
